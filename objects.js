...
let epinfo = netflix.season1.seasonInfo.episodeInfo;
console.log(epinfo[4].episode + ' episode', '"'+ epinfo[4].episodeName + '"')
...
console.log(Object.entries(spaceJam.toonSquad))
